	...
	<div class="col-md-4 col-md-offset-4">
		<div class="panel panel-default">
			<div class="panel-heading">
				<span class="label label-primary label-title label-panel">All Resolved Requests</span>
			</div>
			<div class="panel-body">
				...
				<ul class="list-group">
					<c:forEach var="r" items="${ reimbursementList }" >
						...
						<h4 class="list-group-item-heading"><b>Employee: </b>${ r.employee.firstName } ${ r.employee.lastName }</h4>
						<p class="list-group-item-text">
							<b>Reason: </b>${ r.type.type }
						</p>
						<p class="list-group-item-text">
							<b>Requested on: </b>${ r.requested }
						</p>
						<p class="list-group-item-text">
							<b>Resolved by: </b>${ r.manager.firstName } ${ r.manager.lastName }
						</p>
						<p class="list-group-item-text">
							<b>Resolved on: </b>${ r.resolved }
						</p>
						<p class="list-group-item-text">
						<b>Description: </b>
